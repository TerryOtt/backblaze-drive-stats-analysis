...
## Update With Reading Local Parquet Update

```bash 
$ (Get local Parquet data (backblaze-drive-stats-pyiceberg))
$ source .venv/bin/activate
$ python3 afr_viz_csv.py drives_of_interest_regexes.json \
C:\Users\TDO-XPS15-2024\Downloads\backblaze_drive_stats_2025q3.parquet \
quarterly_afr_2025q3.csv 

Polars datasource: local Parquet file, "C:\Users\TDO-XPS15-2024\Downloads\backblaze_drive_stats_2025q3.parquet"
